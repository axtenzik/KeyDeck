...
namespace KeyDeck
{
    class User32
    {
        ...
        public static extern int GetRawInputData(IntPtr hRawInput, RAWINPUTCOMMAND uiCommand, out RAWINPUT pData, ref uint pcbSize, int cbSizeHeader);

        [DllImport("user32.dll", SetLastError = true, EntryPoint = "GetRawInputDeviceInfoA", CharSet = CharSet.Ansi)]
        public static extern int GetRawInputDeviceInfo(IntPtr hDevice, uint uiCommand, StringBuilder pData, ref uint pcbSize);
